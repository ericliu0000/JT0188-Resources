...
class Example1(Scene):
    def construct(self):
        ...
        g = Graph([0, 1, 2, 3, 4, 5], [(0,1),(1,2),(2,3),(3,4),(4,5)],layout="spring")
                # create a path graph of 6 vertices, with spring layout
        g2 = Graph([0, 1, 2, 3, 4, 5], [(0,1),(1,2),(2,3),(3,4),(4,5)],layout="circular")
        ...
        for i in range(6):
            self.play(Indicate(g.vertices[i],color=BLUE,radius=5))
            self.wait(0.2)
